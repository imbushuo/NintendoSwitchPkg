  ...
  )
{
  ...
  CharCount = AsciiSPrint (Buffer,sizeof (Buffer),"Nintendo Switch UEFI firmware (version %s, commit %a built at %a on %a)\n\r",
	(CHAR16*)PcdGetPtr(PcdFirmwareVersionString), __IMPL_COMMIT_ID__, __TIME__, __DATE__);
